...
const unsigned char statechart[][5] = {
	 { ALLES_STOP1,   'x',  Fussg_Gruen1,  	A_SET_PED_DELAY, 		G_PEDREQUEST_TRUE},
	 ...
	 { ALLES_STOP2,   'x',  Fussg_Gruen2,  	A_SET_PED_DELAY, 		G_PEDREQUEST_TRUE},
	 ...
	 { Fussg_Gruen1,  'x',  Fussg_Gruen1, 	A_DEC_PED_WAIT_CYCLES, 	G_PED_DELAY_NOT_ENDED},
	 { Fussg_Gruen1,  'x',  ALLES_STOP1, 	A_SHOWSTATE, 			G_NOGUARD},

	 { Fussg_Gruen2,  'x',  Fussg_Gruen2, 	A_DEC_PED_WAIT_CYCLES, 	G_PED_DELAY_NOT_ENDED},
	 { Fussg_Gruen2,  'x',  ALLES_STOP2,   	A_SHOWSTATE, 			G_NOGUARD},
