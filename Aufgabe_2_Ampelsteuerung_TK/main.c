...
void Ampel2_rot()		{ P1_5_ON();  P1_4_OFF(); }
void Ampel2_rotgelb()	{ P1_5_ON();  P1_4_ON();  }
void Ampel2_gelb()		{ P1_5_OFF(); P1_4_ON();  }
void Ampel2_leer()		{ P1_5_OFF(); P1_4_OFF(); }

void FussgAmpel_rot()	{ P1_7_ON();  P1_6_OFF(); }
void FussgAmpel_gruen()	{ P1_7_OFF(); P1_6_ON();  }
